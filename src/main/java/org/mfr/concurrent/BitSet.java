...
public final class BitSet {
  ...
  /**
   * If the given {@link BitSet} is large enough to hold
   * {@code numBits+1}, returns the given bits, otherwise returns a new
   * {@link BitSet} which can hold the requested number of bits.
   * <p>
   ...
   */
  public static BitSet ensureCapacity(BitSet bits, long numBits) {
    if (numBits < bits.numBits) {
      ...
      return new BitSet(arr, (long)arr.length << 6);
    }
  }
   ...
   */
  public BitSet(long[] storedBits, long numBits) {
